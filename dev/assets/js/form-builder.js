...
function formBuilderHelpersFn(opts, formBuilder) {
    ...
    _helpers.disabledTT = {
        ...
        add: function add(field) {
            ...
            if (title) {
                var tt = _helpers.markup('p', title, {
                    className: _helpers.disabledTT.className
                });
                field.append(tt);
            }
        },
    ...
    _helpers.confirm = function(message, yesAction) {
        ...
        var yes = _helpers.markup('button', opts.messages.yes, {
                className: 'yes btn btn-success btn-sm'
            }),
            no = _helpers.markup('button', opts.messages.no, {
        ...
        var btnWrap = _helpers.markup('div', [no, yes], {
            className: 'button-wrap'
        });

        className = 'form-builder-dialog ' + className;

        var miniModal = _helpers.markup('div', [message, btnWrap], {
            className: className
        });
        if (!coords) {
            coords = {
    ...
    _helpers.dialog = function(content) {
        ...
        var miniModal = _helpers.markup('div', content, {
            className: className
        });
        if (!coords) {
            coords = {
...
(function($) {
    var FormBuilder = function FormBuilder(options, element) {
        ...
        var cbUl = _helpers.markup('ul', null, {
            id: boxID,
        ...
        var nonEditableFields = function nonEditableFields() {
            ...
            if (opts.prepend && !$('.disabled.prepend', $sortableFields).length) {
                var prependedField = _helpers.markup('li', opts.prepend, {
            ...
            if (opts.append && !$('.disabled.append', $sortableFields).length) {
                var appendedField = _helpers.markup('li', opts.append, {
        ...
        var appendSelectList = function appendSelectList(values) {
            ...
            field += '</ol>';
            var addOption = _helpers.markup('a', opts.messages.addOption, {
                className: 'add add-opt'
            });
            field += _helpers.markup('div', addOption, {
        ...
        var appendFieldLi = function appendFieldLi(title, field, values) {
            ...
            var liContents = _helpers.markup('div', [toggleBtn, delBtn], {
            ...
            liContents += _helpers.markup('div', '', {
            ...
            liContents += field;
            liContents += _helpers.markup('a', opts.messages.close, {
        ...
        clearButton.click(function() {
            ...
            if (fields.length) {
                ...
                _helpers.dialog('There are no fields to clear', {
                    pageX: coords.pageX,
                    pageY: coords.pageY
                });
            }
