...
function formBuilderHelpersFn(e, t) {
    ...
    return t.events = formBuilderEventsFn(), a.attrString = function(e) {
        var t = [];
        for (var l in e) e.hasOwnProperty(l) && (l = a.safeAttr(l, e[l]), t.push(l.name + l.value));
        var s = t.join(" ");
        return s
        ...
        var t = [null, void 0, "", !1];
        for (var a in e) t.inArray(e[a]) && delete e[a];
        return e
    }, a.escapeAttrs = function(e) {
        for (var t in e) e.hasOwnProperty(t) && (e[t] = HTML_ENTITIES.encode(e[t]));
        return e
        ...
        var l = ["checkbox", "checkbox-group", "radio-group"],
            ...
            o = void 0;
        for (o = s.length - 1; o >= 0; o--) s = s.concat(e.messages.subtypes[s[o]]);
        l = l.concat(s);
        var r = a.type,
            n = a.style,
        ...
        if (u) {
            ...
            c.push(u)
        } else l.inArray(r) || c.push("form-control");
        ...
        var t = arguments.length <= 1 || void 0 === arguments[1] ? "" : arguments[1],
            ...
            n = {
                ...
                array: function(e) {
                    for (var t = 0; t < e.length; t++) s = r(e[t]), n[s](e[t])
                }
            };
        for (var i in l)
...
var HTML_ENTITIES = function() {
        ...
        return e.getHtmlTranslationTable = function(e, t) {
            var a, l = {},
                ...
                n = {},
                i = {};
            if (o[0] = "HTML_SPECIALCHARS", o[1] = "HTML_ENTITIES", r[0] = "ENT_NOQUOTES", r[2] = "ENT_COMPAT", r[3] = "ENT_QUOTES", n = isNaN(e) ? e ? e.toUpperCase() : "HTML_SPECIALCHARS" : o[e], i = isNaN(t) ? t ? t.toUpperCase() : "ENT_COMPAT" : r[t], "HTML_SPECIALCHARS" !== n && "HTML_ENTITIES" !== n) throw new Error("Table: " + n + " not supported");
            ...
            for (a in l) l.hasOwnProperty(a) && (s[String.fromCharCode(a)] = l[a]);
            return s
        }, e.encode = function(e, t) {
            var a = this.getHtmlTranslationTable("HTML_ENTITIES", t);
            if (e = null === e ? "" : e + "", !a) return !1;
            t && "ENT_QUOTES" === t && (a["'"] = "&#039;");
    ...
    var t = function(t, a) {
        ...
        var A = function() {
            ...
            S = function(t) {
                ...
                if (t instanceof jQuery) {
                    ...
                    if (s) l = s.attrs, l.label = s.label;
                    else {
        ...
        var M = function(e) {
            ...
            H = function W(t) {
                ...
                for (a in o.roles) - 1 === e.inArray(a, ["date", "4"]) && W.push('<input type="checkbox" name="roles[]" value="' + a + '" id="fld-' + d + "-roles-" + a + '" ' + (-1 !== e.inArray(a, l) ? "checked" : "") + ' class="roles-field" /><label for="fld-' + d + "-roles-" + a + '">' + o.roles[a] + "</label><br/>");
        ...
        i.on("click touchstart", ".remove", function(t) {
            ...
            var t = e(this).parents(".form-field:eq(0)"),
                ...
                l = e(this).val();
            if ("" !== l)
                if (a.length) a.attr("tooltip", l).css("display", "inline-block");
                else {
...
function(e) {
    ...
    Object.assign = function(e) {
        ...
        for (var t = Object(e), a = 1; a < arguments.length; a++) {
            var l = arguments[a];
            if (void 0 !== l && null !== l)
                for (var s in l) l.hasOwnProperty(s) && (t[s] = l[s])
        }
        return t
    }
    ...
    for (var e, t, a = arguments, l = a.length; l && this.length;)
        for (e = a[--l]; - 1 !== (t = this.indexOf(e));) this.splice(t, 1);
    return this
