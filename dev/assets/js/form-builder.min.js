...
function formBuilderHelpersFn(e, t) {
    ...
    return t.events = formBuilderEventsFn(), a.attrString = function (e) {
        var t = [];
        for (var l in e)
            e.hasOwnProperty(l) && (l = a.safeAttr(l, e[l]), t.push(l.name + l.value));
        var s = t.join(" ");
        return s
        ...
        e = a.safeAttrName(e);
        var l = window.JSON.stringify(HTML_ENTITIES.encode(t));
        return t = t ? "=" + l : "", {
            name: e,
            value: t
        }
    ...
    }, a.beforeStop = function (t, l) {
        t = t;
        var s = document.getElementById(e.formID),
                o = s.children.length - 1,
                r = [];
        a.stopIndex = l.placeholder.index() - 1, !e.sortableControls && l.item.parent().hasClass("frmb-control") && r.push(!0), e.prepend && r.push(0 === a.stopIndex), e.append && r.push(a.stopIndex + 1 === o), a.doCancel = r.some(function (e) {
            return e === !0
        })
    ...
    }, a.trimAttrs = function (e) {
        var t = [null, void 0, "", !1];
        for (var a in e)
            t.inArray(e[a]) && delete e[a];
        return e
    }, a.escapeAttrs = function (e) {
        for (var t in e)
            e.hasOwnProperty(t) && (e[t] = HTML_ENTITIES.encode(e[t]));
        return e
    }, a.xmlSave = function (e) {
        var l = $(e).toXML(a);
        return window.JSON.stringify(l) === window.JSON.stringify(t.formData) ? !1 : void(t.formData = l)
    }, a.jsonSave = function () {
        e.notify.warning("json data not available yet")
    }, a.save = function () {
        var l, s = a.getElement(),
                o = document.getElementById(e.formID),
                r = {
                    xml: a.xmlSave,
                    json: a.jsonSave
                };
        return l = r[e.dataType](o), s && (s.value = t.formData, window.jQuery ? $(s).trigger("change") : s.onchange()), document.dispatchEvent(t.events.formSaved), l
    }, a.getElement = function () {
        var l = !1;
        return t.element && (l = t.element, l.id || a.makeId(l), l.onchange || (l.onchange = function () {
        ...
        var t = e.data("fieldData") || {},
                l = e.attr("class");
        if (-1 === l.indexOf("ui-sortable-handle")) {
            var s, o = $(e).attr("type"),
                    r = $(".prev-holder", e),
                    n = {
                        label: $(".fld-label", e).val(),
                        type: o
                    },
            i = $(".fld-subtype", e).val();
            i && (n.subtype = i);
            var c = $(".fld-maxlength", e).val();
            c && (n.maxlength = c), n.className = $(".fld-className", e).val() || t.className || "";
            var d = $(".fld-placeholder", e).val();
            d && (n.placeholder = d);
            var u = $(".btn-style", e).val();
            u && (n.style = u), "checkbox" === o && (n.toggle = $(".checkbox-toggle", e).is(":checked")), o.match(/(select|checkbox-group|radio-group)/) && (n.values = [], n.multiple = $('[name="multiple"]', e).is(":checked"), $(".sortable-options li", e).each(function () {
                var e = {};
                e.selected = $(".option-selected", this).is(":checked"), e.value = $(".option-value", this).val(), e.label = $(".option-label", this).val(), n.values.push(e)
            })), n.className = a.classNames(e, n), $(".fld-className", e).val(n.className), e.data("fieldData", n), s = a.fieldPreview(n), r.html(s), $("input[toggle]", r).kcToggle()
        }
    }, a.fieldPreview = function (t) {
        var l, s = "",
                o = (new Date).getTime();
        t = Object.assign({}, t), t.type = t.subtype || t.type;
        var r = t.toggle ? "toggle" : "",
                n = a.attrString(t);
        switch (t.type) {
            case "textarea":
            case "rich-text":
                s = "<textarea " + n + "></textarea>";
                break;
            case "button":
            case "submit":
                s = "<button " + n + ">" + t.label + "</button>";
                break;
            case "select":
                var i = "",
                        c = t.multiple ? "multiple" : "";
                for (t.values.reverse(), t.placeholder && (i += "<option disabled selected>" + t.placeholder + "</option>"), l = t.values.length - 1; l >= 0; l--) {
                    var d = t.values[l].selected && !t.placeholder ? "selected" : "";
                    i += '<option value="' + t.values[l].value + '" ' + d + ">" + t.values[l].label + "</option>"
                }
                s = "<" + t.type + ' class="' + t.className + '" ' + c + ">" + i + "</" + t.type + ">";
                break;
            case "checkbox-group":
            case "radio-group":
                var u = t.type.replace("-group", ""),
                        p = u + "-" + o;
                for (t.values.reverse(), l = t.values.length - 1; l >= 0; l--) {
                    var m = t.values[l].selected ? "checked" : "",
                            f = u + "-" + o + "-" + l;
                    s += '<div><input type="' + u + '" class="' + t.className + '" name="' + p + '" id="' + f + '" value="' + t.values[l].value + '" ' + m + '/><label for="' + f + '">' + t.values[l].label + "</label></div>"
                }
                break;
            case "text":
            case "password":
            ...
            case "file":
                ...
                break;
            case "color":
                s = '<input type="' + t.type + '" class="' + t.className + '"> ' + e.messages.selectColor;
                break;
            case "hidden":
            case "checkbox":
                s = '<input type="' + t.type + '" ' + r + " >";
                break;
            case "autocomplete":
                s = '<input class="ui-autocomplete-input ' + t.className + '" autocomplete="on">';
                break;
            default:
                s = "<" + t.type + ">" + t.label + "</" + t.type + ">"
        }
        return s
        ...
        var t, a = arguments.length <= 1 || void 0 === arguments[1] ? 250 : arguments[1],
                l = arguments.length <= 2 || void 0 === arguments[2] ? !1 : arguments[2];
        return function () {
            var s = this,
                    o = arguments,
                    r = function () {
                        t = null, l || e.apply(s, o)
                    },
                    n = l && !t;
            clearTimeout(t), t = setTimeout(r, a), n && e.apply(s, o)
        }
        ...
        className: "frmb-tt",
        add: function (t) {
            var l = e.messages.fieldNonEditable;
            if (l) {
                var s = a.markup("p", l, {
    ...
    }, a.classNames = function (t, a) {
        var l = ["checkbox", "checkbox-group", "radio-group"],
                s = ["header", "paragraph", "button"],
                o = void 0;
        for (o = s.length - 1; o >= 0; o--)
            s = s.concat(e.messages.subtypes[s[o]]);
        l = l.concat(s);
        var r = a.type,
                n = a.style,
                i = t[0].querySelector(".fld-className").value,
                c = [].concat(i.split(" ")).reverse(),
                d = {
                    button: "btn",
                    submit: "btn"
                },
        ...
        if (u) {
            ...
            l.inArray(r) || c.push("form-control");
        return c.reverse().unique().join(" ").trim()
    }, a.markup = function (e) {
        ...
        for (var i in l)
            if (l.hasOwnProperty(i) && l[i]) {
                ...
                o.setAttribute(c, l[i])
            }
        return s = r(t), t && n[s].call(this, t), o
        ...
        return s ? d.classList.add("positioned") : (s = {
            pageX: Math.max(document.documentElement.clientWidth, window.innerWidth || 0) / 2,
            pageY: Math.max(document.documentElement.clientHeight, window.innerHeight || 0) / 2
        }, d.style.position = "fixed"), d.style.left = s.pageX + "px", d.style.top = s.pageY + "px", document.body.appendChild(d), n.focus(), d
    }, a.dialog = function (e) {
        var l = arguments.length <= 1 || void 0 === arguments[1] ? !1 : arguments[1],
                s = arguments.length <= 2 || void 0 === arguments[2] ? "" : arguments[2];
        a.showOverlay(), s = "form-builder-dialog " + s;
        var o = a.markup("div", e, {
            className: s
        });
        return l ? o.classList.add("positioned") : (l = {
            pageX: Math.max(document.documentElement.clientWidth, window.innerWidth || 0) / 2,
            pageY: Math.max(document.documentElement.clientHeight, window.innerHeight || 0) / 2
        }, o.style.position = "fixed"), o.style.left = l.pageX + "px", o.style.top = l.pageY + "px", document.body.appendChild(o), -1 !== s.indexOf("data-dialog") && document.dispatchEvent(t.events.viewData), o
    }, a.removeAllfields = function () {
        var t = document.getElementById(e.formID),
                l = t.querySelectorAll("li.form-field"),
                s = $(l),
                o = [];
        ...
        var r = 0;
        s.each(function () {
            r += $(this).outerHeight() + 3;
        }), l[0].style.marginTop = -r + "px", setTimeout(function () {
            s.remove(), document.getElementById(e.formID).classList.remove("removing"), a.save();
        }, 500);
    }, a.setFieldOrder = function (t) {
        if (!e.sortableControls)
            return !1;
        var a = {};
        ...
        var a = !1;
        window.sessionStorage && (e.sortableControls ? a = window.sessionStorage.getItem("fieldOrder") : window.sessionStorage.removeItem("fieldOrder")), a ? (a = window.JSON.parse(a), a = Object.keys(a).map(function (e) {
            return a[e];
        })) : a = e.controlOrder.unique();
        for (var l = [], s = a.length - 1; s >= 0; s--) {
            var o = t.filter(function (e) {
                return e.attrs.type === a[s];
            })[0];
            l.push(o);
        }
...
var HTML_ENTITIES = function () {
    var e = {};
    return e.getHtmlTranslationTable = function (e, t) {
        var a, l = {},
                s = {},
                o = {},
                r = {},
                n = {},
                i = {};
        if (o[0] = "HTML_SPECIALCHARS", o[1] = "HTML_ENTITIES", r[0] = "ENT_NOQUOTES", r[2] = "ENT_COMPAT", r[3] = "ENT_QUOTES", n = isNaN(e) ? e ? e.toUpperCase() : "HTML_SPECIALCHARS" : o[e], i = isNaN(t) ? t ? t.toUpperCase() : "ENT_COMPAT" : r[t], "HTML_SPECIALCHARS" !== n && "HTML_ENTITIES" !== n)
        ...
        for (a in l)
            l.hasOwnProperty(a) && (s[String.fromCharCode(a)] = l[a]);
        return s
    }, e.encode = function (e, t) {
        var a = this.getHtmlTranslationTable("HTML_ENTITIES", t);
        if (e = null === e ? "" : e + "", !a)
            return !1;
        t && "ENT_QUOTES" === t && (a["'"] = "&#039;");
        var l = new RegExp("&(?:#\\d+|#x[\\da-f]+|[a-zA-Z][\\da-z]*);|[" + Object.keys(a).join("").replace(/([()[\]{}\-.*+?^$|\/\\])/g, "\\$1") + "]", "g");
        return e.replace(l, function (e) {
            var t = void 0;
            return e.length > 1 && (t = e), t = a[e]
        })
    }, e
}(HTML_ENTITIES || {}),
...
!function (e) {
    var t = function (t, a) {
        ...
        var r = '<div class="kct-on">' + s.labels.on + "</div>",
                n = '<div class="kct-off">' + s.labels.off + "</div>",
                i = '<div class="kct-handle"></div>',
                c = '<div class="kct-inner">' + r + i + n + "</div>";
            ...
            var t = function (t, a) {
                var l = this,
                        s = {
                            ...
                            controlOrder: ["div", "autocomplete", "button", "checkbox", "checkbox-group", "date", "file", "header", "hidden", "paragraph", "radio-group", "select", "text", "textarea"],
                            dataType: "xml",
                ...
                var o = e.extend(!0, s, t),
                        r = e(a),
                        n = "frmb-" + e("ul[id^=frmb-]").length++;
                o.formID = n, l.element = a;
                var i = e("<ul/>").attr("id", n).addClass("frmb"),
                        c = formBuilderHelpersFn(o, l);
                l.layout = c.editorLayout(o.controlPosition);
                var d = n + "-fld-1",
                        u = n + "-control-box",
                        p = [
                            {
                                label: o.messages.div,
                                attrs: {
                                    type: "div",
                                    className: "text-area",
                                    name: "div"
                ...
                var C = c.debounce(function (t) {
                    if (t && "keyup" === t.type && "className" === this.name)
                        return !1;
                ...
                var A = function () {
                    ...
                    t.some(function (e) {
                        ...
                        O = function () {
                            ...
                            if (a.length > 0)
                                l.formData = t, a.each(function () {
                                    S(e(this))
                                });
                            else if (!t)
                                if (o.defaultFields && o.defaultFields.length) {
                                    o.defaultFields.reverse();
                                    for (var s = o.defaultFields.length - 1; s >= 0; s--)
                                        S(o.defaultFields[s]);
                                    N.removeClass("empty"), c.save()
                                } else
                                    o.prepend || o.append || N.addClass("empty").attr("data-content", o.messages.getStarted);
                ...
                var M = function (e) {
                    ...
                    return e.type + "-" + t
                        ...
                        H = function W(t) {
                            var a, W = [],
                                    l = void 0 !== t.role ? t.role.split(",") : [];
                            W.push(_("label", t)), t.size = t.size || "m", t.style = t.style || "default", W.push(F(t)), W.push(j(t)), W.push(B(t.style, t.type)), W.push(_("placeholder", t)), W.push(_("className", t)), W.push(_("name", t)), W.push('<div class="form-group access-wrap"><label>' + o.messages.roles + "</label>"), W.push('<input type="checkbox" name="enable_roles" value="" ' + (void 0 !== t.role ? "checked" : "") + ' id="enable_roles-' + d + '"/> <label for="enable_roles-' + d + '" class="roles-label">' + o.messages.limitRole + "</label>"), W.push('<div class="available-roles" ' + (void 0 !== t.role ? 'style="display:block"' : "") + ">");
                            for (a in o.roles)
                                -1 === e.inArray(a, ["date", "4"]) && W.push('<input type="checkbox" name="roles[]" value="' + a + '" id="fld-' + d + "-roles-" + a + '" ' + (-1 !== e.inArray(a, l) ? "checked" : "") + ' class="roles-field" /><label for="fld-' + d + "-roles-" + a + '">' + o.roles[a] + "</label><br/>");
                            return W.push("</div></div>"), W.push(_("maxlength", t)), W.join("")
                        },
                        F = function (e) {
                            ...
                            if (t = t.concat(o.messages.subtypes.header, o.messages.subtypes.paragraph), -1 === t.indexOf(e.type) && a.push(!0), a.some(function (e) {
                                ...
                                var s = c.markup("label", o.messages.description, {
                                    "for": "description-" + d
                                }),
                                        r = c.markup("input", null, {
                                            type: "text",
                        ...
                        j = function Y(e) {
                            var t = o.messages.subtypes,
                                    ...
                                    s = void 0;
                            if (t[a]) {
                                var r = "<label>" + o.messages.subtype + "</label>";
                                Y += '<select name="subtype" class="fld-subtype form-control" id="subtype-' + d + '">', t[a].forEach(function (e) {
                                    s = l === e ? "selected" : "", Y += '<option value="' + e + '" ' + s + ">" + e + "</option>"
                                }), Y += "</select>", Y = '<div class="form-group subtype-wrap">' + r + " " + Y + "</div>"
                            }
                            return Y
                        },
                        B = function (e, t) {
                            ...
                            l = o.messages.styles[a[t]],
                                    s = "";
                            if (l) {
                                var r = "<label>" + o.messages.style + "</label>";
                                s += '<input value="' + e + '" name="style" type="hidden" class="btn-style">', s += '<div class="btn-group" role="group">', Object.keys(o.messages.styles[a[t]]).forEach(function (l) {
                                    var r = e === l ? "active" : "";
                                    s += '<button value="' + l + '" type="' + t + '" class="' + r + " btn-xs " + a[t] + " " + a[t] + "-" + l + '">' + o.messages.styles[a[t]][l] + "</button>"
                                }), s += "</div>", s = '<div class="form-group style-wrap">' + r + " " + s + "</div>"
                            }
                            return s
                        },
                        _ = function (e, t) {
                            var a = ["text", "textarea", "select"],
                                    l = ["header"],
                                    s = ["paragraph"],
                                    r = ["checkbox", "select", "checkbox-group", "date", "autocomplete", "radio-group", "hidden", "button", "header"],
                                    n = "label" === e ? t.label : t[e] || "",
                                    i = o.messages[e];
                            "label" === e && s.inArray(t.type) && (i = o.messages.content), l = l.concat(o.messages.subtypes.header, s), r = r.concat(s);
                            var c = o.messages.placeholders,
                                    u = c[e] || "",
                                    p = "",
                                    m = [];
                            if ("placeholder" !== e || a.inArray(t.type) || m.push(!0), "name" === e && l.inArray(t.type) && m.push(!0), "maxlength" === e && r.inArray(t.type) && m.push(!0), !m.some(function (e) {
                                ...
                                var f = "<label>" + i + "</label>";
                                p += "label" === e && s.inArray(t.type) ? '<textarea name="' + e + '" placeholder="' + u + '" class="fld-' + e + ' form-control" id="' + e + "-" + d + '">' + n + "</textarea>" : '<input type="text" value="' + n + '" name="' + e + '" placeholder="' + u + '" class="fld-' + e + ' form-control" id="' + e + "-" + d + '">', p = '<div class="form-group ' + e + '-wrap">' + f + " " + p + "</div>"
                            }
                            return p
                        },
                        P = function (e) {
                            ...
                            if (t.inArray(e.type) && a.push(!0), !a.some(function (e) {
                                ...
                                l += '<div class="form-group">', l += "<label>&nbsp;</label>";
                        ...
                        R = function (t, a, l) {
                            var s = e(a).find('input[name="label"]').val(),
                                    r = s ? s : t,
                                    n = c.markup("a", o.messages.remove, {
                                        id: "del_" + d,
                                    ...
                                    p = l.required,
                                    m = l.toggle || void 0,
                                    f = "" !== l.description ? '<span class="tooltip-element" tooltip="' + l.description + '">?</span>' : "",
                                    v = c.markup("div", [u, n], {
                                        className: "field-actions"
                                    }).outerHTML;
                            v += '<label class="field-label">' + r + "</label>" + f + '<span class="required-asterisk" ' + (p ? 'style="display:inline"' : "") + "> *</span>", v += c.markup("div", "", {
                                className: "prev-holder"
                            }).outerHTML, v += '<div id="' + d + '-holder" class="frm-holder">', v += '<div class="form-elements">', v += P(l), "checkbox" === l.type && (v += '<div class="form-group">', v += "<label>&nbsp;</label>", v += '<input class="checkbox-toggle" type="checkbox" value="1" name="toggle-' + d + '" id="toggle-' + d + '"' + ("true" === m ? " checked" : "") + ' /><label class="toggle-label" for="toggle-' + d + '">' + o.messages.toggle + "</label>", v += "</div>"), v += a, v += c.markup("a", o.messages.close, {
                                className: "close-field"
                            }).outerHTML, v += "</div>", v += "</div>";
                            var g = c.markup("li", v, {
                                "class": l.type + "-field form-field",
                                type: l.type,
                                id: d
                            }),
                                    h = e(g);
                            h.data("fieldData", {
                                attrs: l
                            }), "undefined" != typeof c.stopIndex ? e("> li", i).eq(c.stopIndex).after(h) : i.append(h), c.updatePreview(h), e(document.getElementById("frm-" + d + "-item")).hide().slideDown(250), d = c.incrementId(d)
                        },
                        U = function (e, t, a, l) {
                            var s = {
                                selected: l ? "checkbox" : "radio"
                            },
                            r = {
                                selected: a,
                                label: "",
                ...
                i.on("click touchstart", ".remove", function (t) {
                    ...
                    if (t.stopPropagation(), t.preventDefault(), t.handled === !0)
                        return !1;
                    ...
                    if ("" !== l)
                        if (a.length)
                            a.attr("tooltip", l).css("display", "inline-block");
                        else {
                            var s = '<span class="tooltip-element" tooltip="' + l + '">?</span>';
                    ...
                    if (document.addEventListener("modalClosed", function () {
                        ...
                        var u = c.markup("h3", o.messages.warning),
                                p = c.markup("p", o.messages.fieldRemoveWarning);
                ...
                return X.click(function () {
                    ...
                    }, s) : c.dialog("There are no fields to clear", {
                        pageX: s.pageX,
                        pageY: s.pageY
                    })
                }), e(document.getElementById(n + "-save")).click(function (e) {
                    e.preventDefault(), c.save(), c.validateForm(e)
                }), r.parent().find('p[id*="ideaTemplate"]').remove(), r.wrap('<div class="template-textarea-wrap"/>'), I(), i.css("min-height", f.height()), document.dispatchEvent(l.events.loaded), l
            };
            e.fn.formBuilder = function (a) {
                return this.each(function () {
                    var l, s = this;
                    if (e(s).data("formBuilder")) {
                        var o = e(s).parents(".form-builder:eq(0)"),
                                r = e(s).clone();
                        o.before(r), o.remove(), l = new t(a, r[0]), r.data("formBuilder", l)
                    } else
                        l = new t(a, s), e(s).data("formBuilder", l)
                })
            }
        }(jQuery),
        function (e) {
            e.fn.toXML = function (t) {
                ...
                return this.each(function () {
                    var s = this;
                    s.childNodes.length >= 1 && (a += "<form-template>\n	<fields>", s.childNodes.forEach(function (s) {
                        var o = e(s),
                                r = o.data("fieldData");
                        if (!o.hasClass("disabled")) {
                            ...
                            var d, u = c.type.match(/(select|checkbox-group|radio-group)/),
                                    p = "";
    ...
    for (var e, t, a = arguments, l = a.length; l && this.length; )
        for (e = a[--l]; - 1 !== (t = this.indexOf(e)); )
            this.splice(t, 1);
    return this
